...
// 			modified this line from original to creat earlystop when condition = 1
  ...
  WordSeach.prototype.bobmatrix = function(size) {
	...
	var control_matrix = [
[	'F',	'S',	'P',	'O',	'B',	'W',	'A',	'H',	'X',	'D',	'P',	'U',	'J',	'Y',	'E'	],
[	'M',	'Q',	'L',	'D',	'O',	'R',	'P',	'E',	'Y',	'R',	'U',	'L',	'L',	'N',	'E'	],
[	'R',	'K',	'Y',	'L',	'C',	'B',	'X',	'E',	'F',	'J',	'R',	'O',	'I',	'U',	'E'	],
[	'V',	'N',	'L',	'T',	'C',	'T',	'H',	'R',	'E',	'L',	'P',	'N',	'F',	'L',	'I'	],
[	'B',	'E',	'E',	'P',	'N',	'A',	'X',	'H',	'G',	'A',	'L',	'P',	'E',	'R',	'O'	],
[	'Y',	'T',	'C',	'E',	'Z',	'E',	'S',	'T',	'N',	'E',	'E',	'V',	'Q',	'U',	'C'	],
[	'U',	'G',	'B',	'J',	'T',	'E',	'W',	'Y',	'A',	'T',	'E',	'P',	'B',	'O',	'E'	],
[	'P',	'M',	'D',	'E',	'V',	'R',	'D',	'T',	'R',	'N',	'I',	'L',	'Y',	'F',	'V'	],
[	'E',	'D',	'P',	'E',	'S',	'N',	'I',	'E',	'O',	'T',	'W',	'E',	'L',	'V',	'E'	],
[	'U',	'N',	'N',	'W',	'U',	'E',	'I',	'H',	'D',	'E',	'R',	'L',	'Q',	'C',	'S'	],
[	'L',	'X',	'E',	'G',	'I',	'G',	'F',	'F',	'T',	'H',	'E',	'E',	'B',	'I',	'S'	],
[	'B',	'A',	'R',	'E',	'H',	'Q',	'K',	'C',	'A',	'L',	'B',	'T',	'X',	'V',	'W'	],
[	'E',	'U',	'I',	'T',	'R',	'L',	'I',	'C',	'E',	'N',	'O',	'I',	'G',	'J',	'B'	],
[	'B',	'W',	'V',	'H',	'K',	'G',	'N',	'D',	'X',	'L',	'C',	'H',	'L',	'A',	'D'	],
[	'E',	'E',	'I',	'C',	'D',	'C',	'F',	'P',	'L',	'B',	'D',	'W',	'U',	'X',	'O'	]	
];
...
[	'U',	'F',	'P',	'G',	'B',	'C',	'X',	'T',	'K',	'J',	'J'	]
  ...
  var found_words =[]; // new variable for list of found words
  /**
  ...
  WordSeach.prototype.lookup = function(selected) {
    ...
    if (this.settings.words.indexOf(words[0]) > -1 ||
	  ...
	  //document.getElementById("found_words").innerHTML = found_words; //
	  
	  if(document.getElementById(words[0]).getAttribute("text-decoration") == 'none') {
		var currentscore = score() + 100;
		found_words = found_words.concat(words[0]); // adds found word to list
		console.log(found_words);
		Qualtrics.SurveyEngine.setEmbeddedData('Found_Words',found_words.toString());
		Qualtrics.SurveyEngine.getEmbeddedData ('Found_Words');
	  	document.getElementById("score").innerHTML = "Found " + currentscore + " out of " + this.settings.words.length + " words so far.";
      ...
      for (var i = 0; i < selected.length; i++) {
		...
		var found_words_string = found_words.toString();
  /**
